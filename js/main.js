...
function menus(){
    let Desplazamiento_Actual = window.pageYOffset; /*Retorna el número de píxeles que 
...
function apertura(){
    if(cerrado){     /*al inicio se declaró como verdadero (true)*/
        menu.style.width = '70vw'; /*vw hace referencia al ancho, en este caso del div 
...
window.addEventListener('scroll', function(){ /*al hacer scroll, se activa la función menus() ya pogramada*/
